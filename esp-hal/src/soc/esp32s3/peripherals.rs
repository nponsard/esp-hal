...
crate::peripherals! {
    ...
    pins: [
        ...
        (1, [Input, Output, Analog, RtcIo, Touch])
        (2, [Input, Output, Analog, RtcIo, Touch])
        (3, [Input, Output, Analog, RtcIo, Touch])
        (4, [Input, Output, Analog, RtcIo, Touch])
        (5, [Input, Output, Analog, RtcIo, Touch])
        (6, [Input, Output, Analog, RtcIo, Touch])
        (7, [Input, Output, Analog, RtcIo, Touch])
        (8, [Input, Output, Analog, RtcIo, Touch] () (3 => SUBSPICS1))
        (9, [Input, Output, Analog, RtcIo, Touch] (3 => SUBSPIHD 4 => FSPIHD) (3 => SUBSPIHD 4 => FSPIHD))
        (10, [Input, Output, Analog, RtcIo, Touch] (2 => FSPIIO4 4 => FSPICS0) (2 => FSPIIO4 3 => SUBSPICS0 4 => FSPICS0))
        (11, [Input, Output, Analog, RtcIo, Touch] (2 => FSPIIO5 3 => SUBSPID 4 => FSPID) (2 => FSPIIO5 3 => SUBSPID 4 => FSPID))
        (12, [Input, Output, Analog, RtcIo, Touch] (2 => FSPIIO6 4 => FSPICLK) (2 => FSPIIO6 3=> SUBSPICLK 4 => FSPICLK))
        (13, [Input, Output, Analog, RtcIo, Touch] (2 => FSPIIO7 3 => SUBSPIQ 4 => FSPIQ) (2 => FSPIIO7 3 => SUBSPIQ 4 => FSPIQ))
        (14, [Input, Output, Analog, RtcIo, Touch] (3 => SUBSPIWP 4 => FSPIWP) (2 => FSPIDQS 3 => SUBSPIWP 4 => FSPIWP))
